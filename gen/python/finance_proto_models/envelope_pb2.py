...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZAgithub.com/MaxBernstetter/finance-proto-models/financepb/envelope'
